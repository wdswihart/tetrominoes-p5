class TeeBlock extends Block {
    ...
    update() {
        if (this.angle == 0) {
            ...
            this.cells[2].setIndices(this.i + 1, this.j);
            this.cells[3].setIndices(this.i, this.j + 1);
        } else if (this.angle == 90) {
            this.cells[0].setIndices(this.i, this.j);
            this.cells[1].setIndices(this.i, this.j - 1);
            this.cells[2].setIndices(this.i, this.j + 1);
            this.cells[3].setIndices(this.i - 1, this.j);
